...
scaler=pickle.load(open("ml_projects/cs_students_career_prediction/cs_students_scaler.pkl","rb"))
model=pickle.load(open("ml_projects/cs_students_career_prediction/cs_students_model.pkl","rb"))
gender_encoder=pickle.load(open("ml_projects/cs_students_career_prediction/cs_students_gender_encoder.pkl","rb"))
java_encoder=pickle.load(open("ml_projects/cs_students_career_prediction/cs_students_java_encoder.pkl","rb"))
sql_encoder=pickle.load(open("ml_projects/cs_students_career_prediction/cs_students_sql_encoder.pkl","rb"))
py_encoder=pickle.load(open("ml_projects/cs_students_career_prediction/cs_students_py_encoder.pkl","rb"))
domain_encoder=pickle.load(open("ml_projects/cs_students_career_prediction/cs_students_domain_encoder.pkl","rb"))
project_encoder=pickle.load(open("ml_projects/cs_students_career_prediction/cs_students_project_encoder.pkl","rb"))
with open("ml_projects/cs_students_career_prediction/cs_students_future_career.pkl", "rb") as file:
    future_encoder = pickle.load(file, encoding="latin1")
data=pd.read_csv("ml_projects/cs_students_career_prediction/cs_students.csv")
